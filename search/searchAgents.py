...
def foodHeuristic(state, problem):
  ...
  """
    ...
    # se a lista estiver vazia, ele retorna 0.
    if len(listaComida) == 0:
        return 0

    # distancias e uma colecao de intens onde iremos guardar as distancias entre uma comida e outra
    distancias = set()

    for coordenadas in listaComida:
        # iremos calcular a distancia utilizando a distancia de Manhattan
        distancia = abs( coordenadas[0] - posicao[0] ) + abs( coordenadas[1] - posicao[1] )
